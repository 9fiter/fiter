...
use Fiter\MinecraftAuthBundle\Entity\Skillz;
use Fiter\MinecraftAuthBundle\Form\SkillzType;
...
class SkillzController extends Controller{
    ...
    public function indexAction(){
        ...
        $entities = 
        $paginador->paginate(
            $em->createQuery('SELECT o FROM FiterMinecraftAuthBundle:Skillz o ORDER BY o.level DESC')
        )->getResult();
        return array(
            'entities' => $entities,
            'paginador' => $paginador
    ...
    public function showAction($id){
        $em = $this->getDoctrine()->getManager('minecraft');
        $entity = $em->getRepository('FiterMinecraftAuthBundle:Skillz')->find($id);
    ...
    public function showUserAction($username){
        $em = $this->getDoctrine()->getManager('minecraft');
        $entities = $em->getRepository('FiterMinecraftAuthBundle:Skillz')->findByPlayer($username);
     ...
     * @Method("POST")
     * @Template("FiterMinecraftAuthBundle:Skillz:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("FiterMinecraftAuthBundle:Skillz:edit.html.twig")
     */
