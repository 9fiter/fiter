...
nohup tar jcvf /home/backup/${now}_fullbackup_fiter.tar.bz2 --exclude-from=/home/web/fiter/src/Fiter/BackupBundle/scripts/exclude /home/web/fiter/web/uploads /home/web/fiter/web/mcskin/img > /home/backup/logs/$file.output.log 2> /home/backup/logs/$file.errors.log < /dev/null &