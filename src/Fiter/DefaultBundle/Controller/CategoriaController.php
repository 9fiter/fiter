...
use Fiter\DefaultBundle\Form\CategoriaType;
...
class CategoriaController extends Controller{
     ...
     * @Route("/{id}/{slug}/ver", name="categoria_show")
     * @Template()
     */
     ...
     * @Route("/nuevo", name="categoria_new")
     * @Template()
     */
     ...
     *
     * @Route("/crear", name="_categoria_create")
     * @Method("POST")
     ...
     * @Route("/{id}/{slug}/editar", name="_categoria_edit")
     * @Template()
     */
     ...
     * @Route("/{id}/{slug}/actualizar", name="_categoria_update")
     * @Method("POST")
     ...
     * @Route("/{id}/like", name="categoria_like")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/dislike", name="categoria_dislike")
     * @Template()
     */
     ...
     * @Route("/menu/{slug}/{tipo}", name="menucategoria")
     * @Template()
     */
    public function menuAction($slug,$tipo='articulo',$oculto=false){
        $em = $this->getDoctrine()->getManager();
