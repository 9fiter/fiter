 ...
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="Fiter\DefaultBundle\Entity\SubCategoriaRepository")
 * @ORM\HasLifecycleCallbacks()
 * @Gedmo\TranslationEntity(class="Fiter\DefaultBundle\Entity\Translation\SubCategoriaTranslation")
 */
class SubCategoria{
    ...
    /**
     * @ORM\OneToMany(
     *   targetEntity="Fiter\DefaultBundle\Entity\Translation\SubCategoriaTranslation",
     *   mappedBy="object",
    ...
    //public function addTranslation(Fiter\DefaultBundle\Entity\Translation\SubCategoriaTranslation $t){
