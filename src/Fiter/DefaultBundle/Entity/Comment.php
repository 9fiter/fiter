...
class Comment extends BaseComment implements SignedCommentInterface, VotableCommentInterface{
     ...
     *
     * @var Thread
     * @ORM\ManyToOne(targetEntity="Fiter\DefaultBundle\Entity\Thread")
     */
    protected $thread;
     ...
     */
    protected $author;
    public function setAuthor(UserInterface $author){ $this->author = $author; }
     ...
     */
    public function incrementScore($by = 1){ $this->score += $by; }
