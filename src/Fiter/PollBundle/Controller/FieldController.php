...
class FieldController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FiterPollBundle:Field')->findAll();
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FiterPollBundle:Field')->find($id);
     ...
     * @Method("POST")
     * @Template("FiterPollBundle:Field:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("FiterPollBundle:Field:edit.html.twig")
     */
