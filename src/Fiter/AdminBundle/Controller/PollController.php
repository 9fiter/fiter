...
class PollController extends Controller{
    ...
    public function indexAction()    {
        ...
        $entities = 
        $paginador->paginate(
            $em->getRepository('FiterPollBundle:Poll')->findAll()
        )->getResult();
     ...
     *
     * @Route("/usuario/{nombre}", name="_admin_pollusuario")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/show", name="_admin_poll_show")
     * @Template()
     */
     ...
     * Finds and displays a Poll entity.
     *
     * @Route("/{pollId}/results", name="_admin_poll_results")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/edit", name="_admin_poll_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/update", name="admin_poll_update")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/delete", name="admin_poll_delete")
     * @Method("POST")
     */
