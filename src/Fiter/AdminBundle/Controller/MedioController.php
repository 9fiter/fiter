...
use Fiter\AdminBundle\Form\MedioType;
...
class MedioController extends Controller
{
     ...
     *
     * @Route("/categoria/{slug}/", name="admin_mediocategoria")
     * @Template()
     */
     ...
     * Lists all Medio entities by categoria.
     *
     * @Route("/usuario/{nombre}/", name="admin_mediousuario")
     * @Template()
     */
    ...
    public function indexAction(){
        ...
        $entities = 
        $paginador->paginate(
            $em->getRepository('FiterDefaultBundle:Medio')->findTodosLosMediosDQL()
        )->getResult();
     ...
     *
     * @Route("/{id}/{slug}/ver", name="admin_medio_show")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/like", name="admin_medio_like")
     * @Template()
     */
     ...
     * Adds a like to an Medio entity.
     *
     * @Route("/{id}/dislike", name="admin_medio_dislike")
     * @Template()
     */
     ...
     *
     * @Route("/nuevo", name="admin_medio_new")
     * @Template()
     */
     ...
     *
     * @Route("/crear", name="admin_medio_create")
     * @Method("POST")
     ...
     *
     * @Route("/{id}/{slug}/editar", name="admin_medio_edit")
     * @Template()
     */
     ...
     *
     * @Route("/{id}/{slug}/actualizar", name="admin_medio_update")
     * @Method("POST")
    ...
    public function updateAction(Request $request, $id, $slug)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('medio_edit', array('id' => $id,'slug' => $slug )));
        }
     ...
     *
     * @Route("/{id}/eliminar", name="admin_medio_delete")
     * @Method("POST")
     */
