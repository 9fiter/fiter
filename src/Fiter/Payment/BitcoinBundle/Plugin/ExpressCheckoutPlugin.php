...
namespace Fiter\Payment\BitcoinBundle\Plugin;
...
use Fiter\Payment\BitcoinBundle\Client\Response;
...
class ExpressCheckoutPlugin extends AbstractPlugin{
     ...
     * @param \Fiter\Payment\BitcoinBundle\Client\Client $client
     */
    ...
    public function approveAndDeposit(FinancialTransactionInterface $transaction, $retry){
        //ladybug_dump('approveAndDeposit');
        //ladybug_dump($transaction);
        //ladybug_dump($retry);
    ...
    public function processes($paymentSystemName){
        //ladybug_dump('processes');
        return 'bitcoin_express_checkout' === $paymentSystemName;
    }
    ...
    /**
     * @param \JMS\Payment\CoreBundle\Model\FinancialTransactionInterface $transaction
     * @param \Fiter\Payment\BitcoinBundle\Client\Response $response
     * @return null
    ...
    protected function throwUnlessSuccessResponse(Response $response, FinancialTransactionInterface $transaction){
        ...
        $ex = new FinancialException('Bitcoin-Response was not successful: '.$response);
        $ex->setFinancialTransaction($transaction);
