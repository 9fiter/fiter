...
namespace Fiter\Payment\BitcoinBundle\Tests\Plugin;
...
use Fiter\Payment\BitcoinBundle\Plugin\ExpressCheckoutPlugin;
...
class ExpressCheckoutPluginTest extends \PHPUnit_Framework_TestCase{
    ...
    protected function createTransaction($amount, $currency)
    {
        ...
        $paymentInstruction = new PaymentInstruction($amount, $currency, 'bitcoin_express_checkout', new ExtendedData());
    ...
    /**
     * @return \PHPUnit_Framework_MockObject_MockObject|\Fiter\Payment\BitcoinBundle\Client\Client
     */
    protected function createClientMock($mockedMethods = array())
    {
        return $this->getMock('Fiter\Payment\BitcoinBundle\Client\Client', $mockedMethods, array(), '', false);
    }
}